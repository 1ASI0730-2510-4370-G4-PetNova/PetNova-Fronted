  ...
  <section class="menu-container">
      ...
      <ul>
        <router-link to="/dashboard" class="routering">
          <li class="li-primary-options">
            ...
            <span class="li-primary-options-text">{{
              $t("navbar.inicio")
            }}</span>
          </li>
        </router-link>
        <router-link to="/petsClients" class="routering">
          <li class="li-primary-options">
        ...
        <router-link to="/appointmentsClients" class="routering">
          <li class="li-primary-options">
            <img
              src="../../assets/images/navbar-calendar-icon.png"
              alt="calendar"
            />
            <span class="li-primary-options-text">{{
              $t("navbar.citas")
        ...
        <router-link to="/" class="routering">
          <li class="li-primary-options">
            <img
              src="../../assets/images/navbar-logout-icon.png"
              alt="logout"
            />
            <span class="li-primary-options-text">{{
              $t("navbar.cerrar-sesion")
            }}</span>
          </li>
        </router-link>
      </ul>
    ...
    <section class="menu-footer">
      <ul>
        ...
        <li>
          <span>{{ $t("navbar.terminos") }}</span>
        </li>
        <li>
          <span>{{ $t("navbar.politicas") }}</span>
        </li>
      </ul>
    </section>
  </section>
...
.li-primary-options:hover {
  background-color: #225286;
  cursor: pointer;
}

.li-primary-options-text {
  font-size: 20px;
  margin-left: 15px;
}
